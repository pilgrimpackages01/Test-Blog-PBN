      ...
      <header className="relative z-10 max-w-5xl mx-auto px-6 pt-16 pb-20 text-center space-y-8">
        ...
        <h1 className="text-4xl sm:text-6xl font-black text-white tracking-tight leading-none max-w-4xl mx-auto">
          {site?.seo?.title ? site.seo.title : (
            <>
              Skyrocket Your Google Rankings with High-Authority{' '}
        ...
        <p className="text-slate-400 text-base sm:text-lg max-w-2xl mx-auto leading-relaxed">
          {site?.seo?.description || "Unlock the true ranking potential of your websites. Zero-footprint, niche-relevant, in-content links with full domain authority, completely optimized for Google's latest algorithms."}
        </p>
